        ...
        <div className=" mt16 mt-28 w-screen flex-shrink-0 flex snap-center flex-col space-y-5 items-center p-3 lg:p-20  justify-center md:p-44 h-screen">
          <div className="space-y-10 px-0 md:px-10 max-w-6xl font-Montserrat">
            ...
            <p className="text-sm lg:text-lg text-center md:text-left tracking-tight  leading-[24px] md:leading-[40px]">
              ...
              HTML, CSS, and JavaScript to replicate the Kuda site&apos;s
              functionality and aesthetics. HTML served as the backbone,
              structuring the content and defining the layout of the clone. CSS
              played a crucial role in styling, ensuring that the clone closely
              matched the visual design of the original website, with meticulous
              attention to detail in typography, colors, and responsive design.
              Meanwhile, JavaScript brought interactivity and functionality to
              the clone, enabling dynamic features, interactive elements, and
              real-time data retrieval, making the clone a fully functional
              replica that closely resembled the user experience of the source
              website. Together, these technologies seamlessly combined to
              create a faithful representation of the original website.
            </p>
          </div>
        </div>
      </div>
